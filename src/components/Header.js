                ...
                <article className="flex items-center">
                    ...
                    <nav className="hidden md:block md:ml-5">
                            <ul className="flex items-start justify-start">
                                <li><button className="text-slate-400 hover:text-slate-900">Feautures</button></li>
                                <li className="my-5 md:my-0 md:mx-5"><button className="text-slate-400 hover:text-slate-900">Pricing</button></li>
                                <li><button className="text-slate-400 hover:text-slate-900">Resources</button></li>
                            </ul>
                    </nav>
                </article>
                ...
                {isOpen && (
                    ...
                    <nav className="md:hidden">
                            <ul className="flex flex-col items-center justify-center">
                                <li><button className="text-slate-400">Feautures</button></li>
                                <li className=""><button className="text-slate-400">Pricing</button></li>
